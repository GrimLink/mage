...
function mage_help() {
  ...
  mage_help_cmd "purge"                       "Purge all static assets and caches"
  mage_help_cmd "cleanup [TYPE]"              "Purge assets or caches (types: redis, varnish, opensearch, sample)"
  ...
  mage_help_cmd "new store [URL|PREFIX]"      "Create new store view"
  ...
  mage_help_cmd "add bfcache"                 "Add BFCache compatibility patches"
  mage_help_cmd "add patch"                   "Add patch from file or URL"
  mage_help_cmd "add sample"                  "Add sample data"
  mage_help_cmd "add hyva"                    "Add Hyva Theme"
  mage_help_cmd "add hyva checkout"           "Add Hyva Checkout"
  mage_help_cmd "add hyva commerce"           "Add Hyva Commerce"
  mage_help_cmd "add storeinfo"               "Add Siteation StoreInfo modules"
  mage_help_cmd "add [PKG|GIT_URL]"           "Add composer package or git repository"
